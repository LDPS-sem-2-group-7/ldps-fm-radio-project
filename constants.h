...
const int c_reClk = 2;
const int c_reSw = 4;
const int c_memButton1Pin = 5;//TODO:header file for the constants
const int c_memButton2Pin = 6;
const int c_frequButton1Pin = 9;
const int c_frequButton2Pin = 10;
const int c_timeUp; //some number;
const int c_timeDown; //some number;
//Use pin buttons D7 and D8 to adjust RTC module
